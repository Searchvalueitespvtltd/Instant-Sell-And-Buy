...
//    indicator2.hidden=YES;
    ...
    {    
        ...
        NSString *imagepath1 = (NSString*)[[ItemDetails sharedInstance].dicOtherdetails
                                valueForKey:@"pic_path"];
        NSString *imagepath2 = (NSString*)[[ItemDetails sharedInstance].dicOtherdetails valueForKey:@"pic_path2"];
        NSString *imagepath3 = (NSString*)[[ItemDetails sharedInstance].dicOtherdetails valueForKey:@"pic_path3"];
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            if (![imagepath1 isEqual:[NSNull null]])
            {
...
//                  imgCamera1.image =[UIImage imageNamed: @"addPhoto.png"];
            ...
            if (![imagepath2 isEqual:[NSNull null]])
            {
...
//                imgCamera2.image = [UIImage imageWithData:imageData2];
            ...
            if (![imagepath3 isEqual:[NSNull null]])
            {
