...
- (void) setBadgeForHomeButtonTabValue:(NSString* ) value;
...
-(void)viewWillAppear:(BOOL)animated
{
 ...
 //   [self setBadgeForHomeButtonTabValue:nil];
...
{
    app = APP_DELEGATE;
    app.strchatBadgeValue = nil;
    
    [[[[[app tabBarController]tabBar]items]objectAtIndex:0]setBadgeValue:value];
}
