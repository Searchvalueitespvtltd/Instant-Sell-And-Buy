...
//    }
    ...
    scrollView.contentSize = CGSizeMake(0, 890);
...
//    }
    ...
    NSString *strTemp1 = (NSString*)[self.dicItemDetails valueForKey:@"pic_path"];
    strTemp2 = (NSString*)[self.dicItemDetails valueForKey:@"pic_path2"];
    strTemp3 = (NSString*)[self.dicItemDetails valueForKey:@"pic_path3"];
    
    if ([strTemp1 isEqual:[NSNull null]] && [strTemp2 isEqual:[NSNull null]] && [strTemp3 isEqual:[NSNull null]])
    {
