...
{
    NSLog(@"requestTokenResult %@",[error description]);
}
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    if ([Utils isIPhone_5]) {
        [webView setFrame:CGRectMake(0, 44, 320, 458)];
        [self.label1 setFrame:CGRectMake(2, 522, 320, 20)];
        [self.label2 setFrame:CGRectMake(2, 548, 200, 20)];
    }
