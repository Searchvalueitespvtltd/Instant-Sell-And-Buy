...
#pragma mark - NSUserDefault Update Methods
...
+ (void) removeListInUserDefault:(NSString*) listName
{
    NSUserDefaults* userDefault = [[NSUserDefaults alloc]init];
    NSMutableDictionary* listDic = [[NSMutableDictionary alloc] initWithDictionary:(NSMutableDictionary*)[userDefault objectForKey:listName]];
    NSString* userid = (NSString*)[[NSUserDefaults standardUserDefaults] objectForKey:@"USERID"];
...
+ (void) removeObject:(NSString*) object fromList:(NSString*)list
{
    NSUserDefaults* userDefault = [[NSUserDefaults alloc] init];
    NSMutableDictionary* dic1 = [[NSMutableDictionary alloc] initWithDictionary:(NSDictionary*)[userDefault objectForKey:list]];
    NSString* userid = (NSString*)[[NSUserDefaults standardUserDefaults] objectForKey:@"USERID"];
    ...
    [dic1 removeObjectForKey:userid];
    [dic1 setObject:arr forKey:userid];
    [userDefault setObject:dic1 forKey:list];
    [userDefault release];
}
...
+ (BOOL) checkIfString:(NSString*)object contains:(NSString*)substring
{
    if ([object rangeOfString:substring].location == NSNotFound)
    {
        return NO;
    }
    else
